...
interface FloatingLinesProps {
  // New gradient props (react-bits style)
  gradientStart?: string;
  gradientMid?: string;
  gradientEnd?: string;
  // Legacy array gradient (still supported)
...
export default function FloatingLines({
  ...
  // Resolve gradient: new shorthand props take priority over legacy array
  const resolvedGradient: string[] = (() => {
  ...
  useEffect(() => {
    ...
    // Listen on window so z-index stacking never blocks mouse tracking.
    // We convert clientX/Y to canvas-local coords via getBoundingClientRect.
